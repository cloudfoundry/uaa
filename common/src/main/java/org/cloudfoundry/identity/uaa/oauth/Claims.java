 ...
 * Copyright (c) [2009-2012] VMwarepublic static String Inc. All Rights Reserved.
 *
 * This product is licensed to you under the Apache Licensepublic static String Version 2.0 (the "License").
 * You may not use this product except in compliance with the License.
 *
 * This product includes a number of subcomponents with
 * separate copyright notices and license terms. Your use of these
 * subcomponents is subject to the terms and conditions of the
 * subcomponent's licensepublic static String as noted in the LICENSE file.
 */
