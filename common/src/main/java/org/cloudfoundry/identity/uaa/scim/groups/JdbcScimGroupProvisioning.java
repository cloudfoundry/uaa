...
public class JdbcScimGroupProvisioning implements ScimGroupProvisioning {
    ...
    public ScimGroup retrieveGroup(String id) throws GroupNotFoundException {
        try {
            ...
            throw new GroupNotFoundException("Group " + id + " does not exist");
        }
    }
    ...
    public ScimGroup retrieveGroupByName(String name) throws GroupNotFoundException {
        try {
            ...
            throw new GroupNotFoundException("Group " + name + " does not exist");
        }
    }

    @Override
    public ScimGroup createGroup(final ScimGroup group) throws InvalidGroupException {
        ...
        try {
            ...
            throw new GroupAlreadyExistsException("A group with displayName: " + group.getDisplayName() + " already exists.");
        }
    ...
    @Override
    public ScimGroup updateGroup(final String id, final ScimGroup group) throws InvalidGroupException, GroupNotFoundException {
        ...
        try {
            ...
            throw new InvalidGroupException("A group with displayName: " + group.getDisplayName() + " already exists");
        }
    }
    ...
    protected void checkIfUpdateAllowed (String groupId) {
        ...
        if (context.isUser()) {
            if (membershipManager.getAdminMembers(groupId).contains(new ScimGroupMember(context.getUserId()))) {
                return;
            } else throw new ScimException(context.getUserId() + " does not have privileges to update group: " + groupId, HttpStatus.UNAUTHORIZED);
        }
