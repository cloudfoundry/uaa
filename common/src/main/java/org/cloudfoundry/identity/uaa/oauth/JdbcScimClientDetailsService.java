...
public class JdbcScimClientDetailsService extends AbstractQueriable<ClientDetails> implements ScimClientDetailsService {
	...
	public JdbcScimClientDetailsService(JdbcClientDetailsService delegate, JdbcTemplate jdbcTemplate) {
	...
	public List<ClientDetails> query(String filter) {
		return super.query(filter);    //To change body of overridden methods use File | Settings | File Templates.
	}
