...
public class ApprovalsAdminEndpoints implements InitializingBean {
	...
	public void setApprovalsManager(ApprovalsManager approvalsManager) {
	...
	public List<Approval> getApprovals(@RequestParam(required = false, defaultValue = "userName pr") String filter,
		...
		return approvalsManager.getApprovals(String.format("%s and " + USER_FILTER_TEMPLATE, filter, username))
	...
	public List<Approval> updateApprovals(@RequestBody Collection<Approval> approvals) {
		...
		approvalsManager.revokeApprovals(String.format(USER_FILTER_TEMPLATE, username));
		for (Approval approval : approvals) {
			...
			approvalsManager.addApproval(approval);
		}
		return approvalsManager.getApprovals(String.format(USER_FILTER_TEMPLATE, username));
	}
	...
	public void afterPropertiesSet() throws Exception {
		Assert.notNull(approvalsManager, "Please supply an approvals manager");
