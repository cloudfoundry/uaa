...
public interface ScimGroupMembershipManager {
	...
	/**
	 * Retrieve all 'user' type members (leaving out 'group' type members) of a group.
	 * @param groupId
	 * @param transitive true means indirect/transitive membership is also processed ('user' members of sub-groups)
	 * @return
	 * @throws ScimResourceNotFoundException
	 */
//	Set<ScimGroupMember> getEndUserMembers(String groupId, boolean transitive) throws ScimResourceNotFoundException;
