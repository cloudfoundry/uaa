...
public class ApprovalsAdminEndpointsTests {
	...
	public void canUpdateApprovals() {
		List<Approval> app = Arrays.asList(new Approval("marissa", "c1", "uaa.user", 2000, APPROVED),
	...
	public void userCannotUpdateApprovalsForAnotherUser() {
		...
		endpoints.updateApprovals(Arrays.asList(new Approval("marissa", "c1", "uaa.user", 2000, APPROVED)));
	}
