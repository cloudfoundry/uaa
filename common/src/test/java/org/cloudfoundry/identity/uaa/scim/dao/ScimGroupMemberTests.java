package org.cloudfoundry.identity.uaa.scim.dao;
...
public class ScimGroupMemberTests {
	...
	private static final ScimGroupMember m2 = new ScimGroupMember("m1", ScimGroupMember.Type.USER, ScimGroup.GROUP_ADMIN);
	private static final ScimGroupMember m3 = new ScimGroupMember("m1", ScimGroupMember.Type.USER, ScimGroup.GROUP_MEMBER);
	private static final ScimGroupMember m4 = new ScimGroupMember("m1", ScimGroupMember.Type.GROUP, ScimGroup.GROUP_MEMBER);
	private static final ScimGroupMember m5 = new ScimGroupMember("m1", ScimGroupMember.Type.GROUP, ScimGroup.GROUP_ADMIN);
	private static final ScimGroupMember m6 = new ScimGroupMember("m1", ScimGroupMember.Type.GROUP, null);
	private static final ScimGroupMember m7 = new ScimGroupMember("m2", ScimGroupMember.Type.USER, ScimGroup.GROUP_MEMBER);
