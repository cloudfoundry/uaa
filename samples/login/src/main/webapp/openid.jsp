...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/stylesheets/openid.css'/>" />
    <script type="text/javascript" src="<c:url value='/resources/javascripts/jquery.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/javascripts/openid-jquery.js'/>"></script>
