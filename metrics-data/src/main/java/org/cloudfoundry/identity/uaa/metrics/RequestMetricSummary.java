...
public class RequestMetricSummary {
  ...
  public RequestMetricSummary(
      ...
      @JsonProperty("averageDatabaseIntolerableQueryTime")
  ...
  public synchronized void add(
      ...
      long dbQueries,
      long dbTime,
      long failedDbQueries,
      long failedDbQueryTime) {
    ...
    averageDatabaseQueryTime =
        addToAverage(databaseQueryCount, averageDatabaseQueryTime, dbQueries, dbTime);
    databaseQueryCount += dbQueries;

    averageDatabaseIntolerableQueryTime =
        addToAverage(
            databaseIntolerableQueryCount,
            averageDatabaseIntolerableQueryTime,
            failedDbQueries,
            failedDbQueryTime);
