...
public class TestAccountSetup extends TestWatchman {
    ...
    private void createCfClient(RestOperations client) {
        UaaBaseClientDetails clientDetails = new UaaBaseClientDetails("cf", "cloud_controller,openid,password",
    ...
    private void createScimClient(RestOperations client) {
        UaaBaseClientDetails clientDetails = new UaaBaseClientDetails("scim", "oauth", "uaa.none", "client_credentials",
    ...
    private void createAppClient(RestOperations client) {
        UaaBaseClientDetails clientDetails = new UaaBaseClientDetails("app", "none",
