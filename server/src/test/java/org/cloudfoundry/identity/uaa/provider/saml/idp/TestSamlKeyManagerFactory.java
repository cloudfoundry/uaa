...
public final class TestSamlKeyManagerFactory {

    protected final static Logger logger = LoggerFactory.getLogger(TestSamlKeyManagerFactory.class);

    public TestSamlKeyManagerFactory() {
    }
