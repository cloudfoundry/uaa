...
import org.cloudfoundry.identity.uaa.alias.EntityAliasHandlerTest;
...
public class IdentityProviderAliasHandlerTest extends EntityAliasHandlerTest<IdentityProvider<?>> {
    @Mock
    ...
    class Validation {
        ...
        class NoExistingAlias {
            @Nested
            class AliasFeatureEnabled extends Validation_NoExistingAlias_AliasFeatureEnabled {
                @ParameterizedTest
                @MethodSource
            ...
            @Nested
            class AliasFeatureDisabled extends Validation_NoExistingAlias_AliasFeatureDisabled {
        ...
        class ExistingAlias {
            @Nested
            class AliasFeatureEnabled extends Validation_ExistingAlias_AliasFeatureEnabled {
                // all tests defined in superclass
            }

            @Nested
            class AliasFeatureDisabled extends Validation_ExistingAlias_AliasFeatureDisabled {
                // all tests defined in superclass
            }
        }
    }
