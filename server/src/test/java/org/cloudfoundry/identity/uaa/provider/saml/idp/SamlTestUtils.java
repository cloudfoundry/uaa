...
public class SamlTestUtils {
    ...
    public String mockAssertionEncoded(Assertion assertion, String issuerEntityID, String format, String nameId, String spEndpoint, String audienceEntityID) throws Exception {
        Assertion _in = assertion == null ? mockAssertion(issuerEntityID, format, nameId, spEndpoint, audienceEntityID) : assertion;
    ...
    public String mockAssertionEncoded(String issuerEntityID, String format, String nameId, String spEndpoint, String audienceEntityID) throws Exception {
        return mockAssertionEncoded(null, issuerEntityID, format, nameId, spEndpoint, audienceEntityID);
    }
