...
class XOAuthAuthenticationFilterTest {
    ...
    private XOAuthAuthenticationFilter externalOAuthAuthenticationFilter;
    private XOAuthAuthenticationManager externalOAuthAuthenticationManager;
    private FilterChain mockFilterChain;

    @BeforeEach
    void setUp() {
        externalOAuthAuthenticationManager = mock(XOAuthAuthenticationManager.class);
    ...
    class WhenAuthenticationSucceeds {
        ...
        void itShouldCallTheNextFilter() throws IOException, ServletException {
            externalOAuthAuthenticationFilter = new XOAuthAuthenticationFilter(externalOAuthAuthenticationManager, null);
        ...
        void itCallsTheSuccessHandler() throws IOException, ServletException {
            ...
            externalOAuthAuthenticationFilter = new XOAuthAuthenticationFilter(externalOAuthAuthenticationManager, successHandler);
            HttpServletRequest mockRequest = mockRedirectRequest(ORIGIN_KEY, (request) -> {
                mockAuthenticationInRequest(request);
                mockStateParamInRequest(request, OAUTH_STATE);
                mockStateParamInSession(request.getSession(), ORIGIN_KEY, OAUTH_STATE);
