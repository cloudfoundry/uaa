...
class ScimGroupBootstrapTests {
    ...
    void initScimGroupBootstrapTests() throws SQLException {
        ...
        uDB = new JdbcScimUserProvisioning(template, pagingListFactory, passwordEncoder, new IdentityZoneManagerImpl(), new JdbcIdentityZoneProvisioning(jdbcTemplate), new TimeServiceImpl(), new SimpleSearchQueryConverter());
