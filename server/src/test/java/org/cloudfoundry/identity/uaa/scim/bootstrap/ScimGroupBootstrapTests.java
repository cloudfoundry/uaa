...
class ScimGroupBootstrapTests {
    ...
    void initScimGroupBootstrapTests() throws SQLException {
        ...
        uDB = new JdbcScimUserProvisioning(template, pagingListFactory, passwordEncoder, new IdentityZoneManagerImpl(), null, new TimeServiceImpl(), new SimpleSearchQueryConverter());
