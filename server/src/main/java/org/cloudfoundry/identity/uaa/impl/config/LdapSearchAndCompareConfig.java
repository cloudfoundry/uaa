...
public class LdapSearchAndCompareConfig {
  ...
  public LdapAuthenticationProvider ldapAuthProvider(
    ...
    String passwordAttributeName =
        ofNullable(environment.getProperty("ldap.base.passwordAttributeName"))
            .orElse("userPassword");
    String passwordEncoderClassName =
        ofNullable(environment.getProperty("ldap.base.passwordEncoder"))
            .orElse("org.cloudfoundry.identity.uaa.provider.ldap.DynamicPasswordComparator");
    PasswordEncoder passwordEncoder =
        (PasswordEncoder) Class.forName(passwordEncoderClassName).newInstance();
    boolean localCompare =
        ofNullable(environment.getProperty("ldap.base.localPasswordCompare"))
