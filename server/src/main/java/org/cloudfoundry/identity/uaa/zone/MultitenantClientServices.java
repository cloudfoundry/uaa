...
interface MultitenantClientRegistrationService extends ClientRegistrationService {
  ...
  void addClientDetails(ClientDetails clientDetails, String zoneId)
      throws ClientAlreadyExistsException;

  void updateClientDetails(ClientDetails clientDetails, String zoneId) throws NoSuchClientException;

  void updateClientSecret(String clientId, String secret, String zoneId)
...
interface MultitenantClientDetailsService extends ClientDetailsService {
  ...
  ClientDetails loadClientByClientId(String clientId, String zoneId)
      throws ClientRegistrationException;
}

interface MultitenantClientSecretService {

  void addClientSecret(String clientId, String newSecret, String zoneId)
      throws NoSuchClientException;

  void deleteClientSecret(String clientId, String zoneId) throws NoSuchClientException;
}

public abstract class MultitenantClientServices
    implements MultitenantClientRegistrationService,
  ...
  @Override
  public final void addClientDetails(ClientDetails clientDetails)
      throws ClientAlreadyExistsException {
  ...
  @Override
  public final void updateClientSecret(String clientId, String secret)
      throws NoSuchClientException {
  ...
  @Override
  public final ClientDetails loadClientByClientId(String clientId)
      throws ClientRegistrationException {
