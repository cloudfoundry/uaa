...
public class ClientMetadataAdminEndpoints {
  ...
  public ClientMetadataAdminEndpoints(
      final @Qualifier("jdbcClientMetadataProvisioning") ClientMetadataProvisioning
  ...
  public ClientMetadata retrieveClientMetadata(@PathVariable("client") String clientId) {
    try {
      ...
      throw new ClientMetadataException(
          "No client metadata found for " + clientId, HttpStatus.NOT_FOUND);
    }
  }
  ...
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
  public ClientMetadata updateClientMetadata(
    ...
    try {
      ...
      throw new ClientMetadataException(
          "No client with ID " + clientMetadata.getClientId(), HttpStatus.NOT_FOUND);
    }
  }
  ...
  public View handleException(ClientMetadataException cme, HttpServletRequest request) {
    ...
    return new ConvertingExceptionView(
        new ResponseEntity<>(new ExceptionReport(cme, trace, cme.getExtraInfo()), cme.getStatus()),
        messageConverters);
  }
}
