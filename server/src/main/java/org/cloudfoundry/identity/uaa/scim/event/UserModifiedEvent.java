...
public class UserModifiedEvent extends AbstractUaaEvent {
  ...
  private UserModifiedEvent(
      final ScimUser scimUser, final AuditEventType eventType, final String zoneId) {
  ...
  public AuditEvent getAuditEvent() {
    ...
    return createAuditRecord(scimUser.getId(), eventType, getOrigin(getAuthentication()), data);
  }

  private String[] buildDetails() {
    return new String[] {"user_id=" + scimUser.getId(), "username=" + scimUser.getUserName()};
  }
