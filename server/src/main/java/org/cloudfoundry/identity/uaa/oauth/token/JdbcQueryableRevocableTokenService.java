...
public class JdbcQueryableRevocableTokenService extends AbstractQueryable<ClientDetails> implements
                QueryableResourceManager<ClientDetails> {

    private static final Log logger = LogFactory.getLog(JdbcQueryableRevocableTokenService.class);

    private JdbcRevocableTokenProvisioning delegate;
    ...
    public JdbcQueryableRevocableTokenService(JdbcClientDetailsService delegate, JdbcTemplate jdbcTemplate,
