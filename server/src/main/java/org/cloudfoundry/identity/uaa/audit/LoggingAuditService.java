...
public class LoggingAuditService implements UaaAuditService {
  ...
  @ManagedMetric(
      ...
      displayName = "User Successful Authentication Count")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "Client Successful Authentication Count")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "Client Authentication Failure Count")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "Principal (non-user) Authentication Failure Count")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "Principal (non-user) Not Found Count")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "User Password Change Count (Since Startup)")
  ...
  @ManagedMetric(
      metricType = MetricType.COUNTER,
      displayName = "User Password Change Failure Count (Since Startup)")
  ...
  public void log(AuditEvent auditEvent, String zoneId) {
    ...
    String logMessage =
        String.format(
            "%s ('%s'): principal=%s, origin=[%s], identityZoneId=[%s]",
    ...
    if (auditEvent.getAuthenticationType() != null) {
      logMessage =
          String.format(
              "%s, authenticationType=[%s]", logMessage, auditEvent.getAuthenticationType());
    }
