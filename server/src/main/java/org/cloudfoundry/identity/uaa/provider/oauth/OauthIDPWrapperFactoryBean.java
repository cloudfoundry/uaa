...
public class OauthIDPWrapperFactoryBean {
  ...
  private Map<String, AbstractExternalOAuthIdentityProviderDefinition> oauthIdpDefinitions =
      new HashMap<>();
      ...
      for (String alias : definitions.keySet()) {
        ...
        try {
          ...
          if (OAUTH20.equalsIgnoreCase(type)) {
            RawExternalOAuthIdentityProviderDefinition oauthIdentityProviderDefinition =
                new RawExternalOAuthIdentityProviderDefinition();
            oauthIdentityProviderDefinition.setCheckTokenUrl(
                idpDefinitionMap.get("checkTokenUrl") == null
                    ? null
                    : new URL((String) idpDefinitionMap.get("checkTokenUrl")));
            ...
            oidcIdentityProviderDefinition.setUserInfoUrl(
                idpDefinitionMap.get("userInfoUrl") == null
                    ? null
                    : new URL((String) idpDefinitionMap.get("userInfoUrl")));
            oidcIdentityProviderDefinition.setPasswordGrantEnabled(
                idpDefinitionMap.get("passwordGrantEnabled") == null
                    ? false
                    : (boolean) idpDefinitionMap.get("passwordGrantEnabled"));
            oidcIdentityProviderDefinition.setSetForwardHeader(
                idpDefinitionMap.get("setForwardHeader") == null
                    ? false
                    : (boolean) idpDefinitionMap.get("passwordGrantEnabled"));
            oidcIdentityProviderDefinition.setPrompts(
                (List<Prompt>) idpDefinitionMap.get("prompts"));
            ...
            throw new IllegalArgumentException(
                "Unknown type for provider. Type must be oauth2.0 or oidc1.0. (Was " + type + ")");
          }
          ...
          IdentityProviderWrapper wrapper =
              getIdentityProviderWrapper(alias, rawDef, provider, override);

          providers.add(wrapper);
        } catch (MalformedURLException e) {
          throw new IllegalArgumentException(
              "OAuth/OIDC Provider Configuration - URL is malformed.", e);
        }
      }
    }
  }

  public static IdentityProviderWrapper getIdentityProviderWrapper(
      String origin,
      AbstractExternalOAuthIdentityProviderDefinition rawDef,
  ...
  protected void setCommonProperties(
      Map<String, Object> idpDefinitionMap,
      AbstractExternalOAuthIdentityProviderDefinition idpDefinition) {
    ...
    idpDefinition.setShowLinkText(
        idpDefinitionMap.get("showLinkText") == null
            ? true
            : (boolean) idpDefinitionMap.get("showLinkText"));
    idpDefinition.setAddShadowUserOnLogin(
        idpDefinitionMap.get("addShadowUserOnLogin") == null
            ? true
            : (boolean) idpDefinitionMap.get("addShadowUserOnLogin"));
    idpDefinition.setStoreCustomAttributes(
        idpDefinitionMap.get(STORE_CUSTOM_ATTRIBUTES_NAME) == null
            ? true
            : (boolean) idpDefinitionMap.get(STORE_CUSTOM_ATTRIBUTES_NAME));
    idpDefinition.setSkipSslValidation(
        idpDefinitionMap.get("skipSslValidation") == null
            ? false
            : (boolean) idpDefinitionMap.get("skipSslValidation"));
    idpDefinition.setTokenKey((String) idpDefinitionMap.get("tokenKey"));
    idpDefinition.setIssuer((String) idpDefinitionMap.get("issuer"));
    idpDefinition.setAttributeMappings(
        (Map<String, Object>) idpDefinitionMap.get(ATTRIBUTE_MAPPINGS));
    ...
    try {
      if (hasText(discoveryUrl) && idpDefinition instanceof OIDCIdentityProviderDefinition) {
        ...
        idpDefinition.setTokenKeyUrl(
            idpDefinitionMap.get("tokenKeyUrl") == null
                ? null
                : new URL((String) idpDefinitionMap.get("tokenKeyUrl")));
  ...
  public void setOauthIdpDefinitions(
      Map<String, AbstractExternalOAuthIdentityProviderDefinition> oauthIdpDefinitions) {
