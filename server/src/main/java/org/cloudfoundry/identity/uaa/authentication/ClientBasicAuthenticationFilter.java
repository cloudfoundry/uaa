 ...
 *
 * <p>This filter properly decodes a basic auth header of the form: Authentication: Basic
 * base64encode(urlencode(client_id):urlencode(client_secret))
 *
 * <p>Fun fact: this class is almost an exact copy of the Spring Framework {@link
 * BasicAuthenticationFilter} version 5.1.5.RELEASE.
 */
public class ClientBasicAuthenticationFilter extends OncePerRequestFilter {
   ...
   */
  public ClientBasicAuthenticationFilter(
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (debug) {
        this.logger.debug(
            "Basic Authentication Authorization header found for user '" + clientId + "'");
      }
