...
public class BuildInfo implements InitializingBean {
  ...
  public void afterPropertiesSet() {
    ...
    Assert.hasText(
        uaaUrl, "[Assertion failed] - uaaUrl must have text; it must not be null, empty, or blank");
    Assert.hasText(
        version,
        "[Assertion failed] - version must have text; it must not be null, empty, or blank");
    Assert.hasText(
        commitId,
        "[Assertion failed] - commitId must have text; it must not be null, empty, or blank");
    Assert.hasText(
        timestamp,
        "[Assertion failed] - timestamp must have text; it must not be null, empty, or blank");
  }
