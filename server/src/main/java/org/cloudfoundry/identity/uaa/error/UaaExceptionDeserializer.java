...
public class UaaExceptionDeserializer extends JsonDeserializer<UaaException> {
  ...
  @Override
  public UaaException deserialize(JsonParser jp, DeserializationContext ctxt)
    ...
    String errorMessage =
        errorParams.containsKey("error_description") ? errorParams.get("error_description") : null;
