...
public class FlywayConfiguration {
   ...
   *
   * <p>We need to maintain backwards compatibility due to {@link FixFailedBackportMigrations_4_0_4}
   */
  static final String VERSION_TABLE = "schema_version";

  /**
   * @param dataSourceAccessor This bean does NOT need need an instance of {@link
   *     DataSourceAccessor}. However, other Flyway objects (example {@link V1_5_3__InitialDBScript}
