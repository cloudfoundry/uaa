 ...
 *
 * <p>Contains the data required for an authenticated user within the UAA application itself.
 */
public class UaaPrincipal implements Principal, Serializable {
  ...
  /**
   * Returns {@code true} if the supplied object is a {@code UAAPrincipal} instance with the same
   * {@code id} value.
   *
   * <p>In other words, the objects are equal if they have the same user id, representing the same
   * principal.
   */
  @Override
