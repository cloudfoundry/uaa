...
public class UaaConfiguration {
  ...
  @Valid public PasswordPolicy passwordPolicy;
  @Valid public Database database;
  @Valid public Logging logging;
  @Valid public Jwt jwt;
  @Valid public OAuth oauth;
  @Valid public Scim scim;
  @Valid public CloudController cloud_controller;
  @Valid public Map<String, Object> ldap;

  @Valid public Map<String, Object> login;
  @Valid public Map<String, Object> logout;
  @Valid public Map<String, Object> links;
  @Valid public Map<String, Object> smtp;
  @Valid public Map<String, Object> tiles;
  @Valid public Map<String, Object> servlet;
  @Valid public Map<String, Object> password;
  @Valid public Map<String, Object> authentication;
  @Valid public Map<String, Object> notifications;
  @Valid public Map<String, Object> uaa;
  @Valid public String assetBaseUrl;
  @Valid public String LOGIN_SECRET;
  @Valid public OAuth multitenant;
  @Valid public Map<String, Object> cors;
  ...
  public static class Zones {
    ...
    @Valid public InternalZone internal;
  ...
  public static class OAuth {
    ...
    @Valid public Client client;
    @Valid public Authorize authorize;
    @Valid public Map<String, OAuthClient> clients;
    ...
    public static class Authorize {
      ...
      @NotNull public boolean ssl;
    }

    public static class User {

      @Valid public Set<String> authorities;
    }
  ...
  public static class OAuthClient {
    ...
    @NotNull public String grantTypes;
