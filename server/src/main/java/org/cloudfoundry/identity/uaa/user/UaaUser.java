...
public class UaaUser {
  ...
  public UaaUser(
      String username, String password, String email, String givenName, String familyName) {
    this(
        "NaN",
        username,
        password,
  ...
  public static UaaUser createWithDefaults(Consumer<UaaUserPrototype> config) {
    ...
    if (prototype.getUsername() == null) {
      prototype.withUsername(
          prototype.getEmail() != null ? prototype.getEmail() : DEFAULT_USER_NAME);
    }
  ...
  public UaaUser modifyAttributes(
      String email, String givenName, String familyName, String phoneNumber, boolean verified) {
    return new UaaUser(
        new UaaUserPrototype()
            .withEmail(email)
            .withGivenName(givenName)
