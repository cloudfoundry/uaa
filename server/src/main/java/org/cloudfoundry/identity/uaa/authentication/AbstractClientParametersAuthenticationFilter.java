...
public abstract class AbstractClientParametersAuthenticationFilter implements Filter {
  ...
  public abstract void wrapClientCredentialLogin(
      HttpServletRequest req,
      HttpServletResponse res,
      Map<String, String> loginInfo,
      String clientId);

  protected void doClientCredentialLogin(
      HttpServletRequest req, Map<String, String> loginInfo, String clientId) {
  ...
  private Authentication performClientAuthentication(
      HttpServletRequest req, Map<String, String> loginInfo, String clientId) {
    ...
    try {
      ...
      OAuth2Authentication result =
          new OAuth2Authentication(authorizationRequest.createOAuth2Request(), null);
