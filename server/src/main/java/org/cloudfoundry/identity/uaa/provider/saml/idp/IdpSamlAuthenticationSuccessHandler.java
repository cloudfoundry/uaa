...
/**
 * Use this class in conjunction with org.springframework.security.saml.SAMLProcessingFilter to
 * create a SAML Response after SAMLProcessingFilter successfully processes a SAML Authentication
 * Request.
 */
public class IdpSamlAuthenticationSuccessHandler implements AuthenticationSuccessHandler {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(IdpSamlAuthenticationSuccessHandler.class);
  ...
  public void onAuthenticationSuccess(
    ...
    try {
      extendedMetadata =
          (IdpExtendedMetadata) metadataManager.getExtendedMetadata(context.getLocalEntityId());
  ...
  protected void populatePeerContext(SAMLMessageContext samlContext)
    ...
    RoleDescriptor roleDescriptor =
        metadataManager.getRole(peerEntityId, peerEntityRole, SAMLConstants.SAML20P_NS);
