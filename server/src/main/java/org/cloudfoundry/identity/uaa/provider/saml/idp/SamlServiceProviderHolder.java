...
public class SamlServiceProviderHolder {
  ...
  public SamlServiceProviderHolder(
      ExtendedMetadataDelegate extendedMetadataDelegate, SamlServiceProvider samlServiceProvider) {
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((samlServiceProvider.getIdentityZoneId() == null)
                ? 0
                : samlServiceProvider.getIdentityZoneId().hashCode());
    result =
        prime * result
            + ((samlServiceProvider.getEntityId() == null)
                ? 0
                : samlServiceProvider.getEntityId().hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!samlServiceProvider
        .getIdentityZoneId()
        .equals(other.samlServiceProvider.getIdentityZoneId())) {
      return false;
    }
