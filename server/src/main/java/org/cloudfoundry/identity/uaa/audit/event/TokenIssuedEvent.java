...
public class TokenIssuedEvent extends AbstractUaaEvent {
  ...
  public AuditEvent getAuditEvent() {
    ...
    return createAuditRecord(
        getPrincipalId(), AuditEventType.TokenIssuedEvent, getOrigin(getAuthentication()), data);
  }
  ...
  private String getPrincipalId() {
    ...
    Map<String, Object> claims =
        JsonUtils.readValue(jwt.getClaims(), new TypeReference<Map<String, Object>>() {});
    return (claims.get("user_id") != null ? claims.get("user_id") : claims.get("client_id"))
        .toString();
  }
}
