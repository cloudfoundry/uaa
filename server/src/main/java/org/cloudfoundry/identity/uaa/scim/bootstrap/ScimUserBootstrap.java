...
public class ScimUserBootstrap implements
    ...
    private void updateUser(ScimUser existingUser, UaaUser updatedUser, boolean updateGroups) {
        ...
        if (updateGroups) {
            ...
            addGroups(id, updatedUser.getOrigin(), newGroups);
        }
    }
    ...
    private void createNewUser(UaaUser user) {
        ...
        addGroups(newScimUser.getId(), user.getOrigin(), convertToGroups(user.getAuthorities()));
    }

    private void addGroups(String scimUserid, String origin, Collection<String> groups) {
        for (String group : groups) {
            addToGroup(scimUserid, origin, group);
        }
    }
    ...
    private void addToGroup(String scimUserId, String origin, String gName) {
        addToGroup(scimUserId, gName, origin, true);
    }
