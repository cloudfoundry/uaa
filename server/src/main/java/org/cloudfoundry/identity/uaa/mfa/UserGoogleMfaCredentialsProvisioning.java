...
public class UserGoogleMfaCredentialsProvisioning implements ICredentialRepository {
  ...
  private static Logger logger =
      LoggerFactory.getLogger(UserGoogleMfaCredentialsProvisioning.class);
  ...
  public UserGoogleMfaCredentials getUserGoogleMfaCredentials(String userId) {
    MfaProvider provider =
        mfaProviderProvisioning.retrieveByName(
  ...
  public String getOtpAuthURL(
      String qrIssuer, UserGoogleMfaCredentials credentials, String userName)
      throws IOException, WriterException {
    return MfaRegisterQRGenerator.getQRCodePngDataUri(
        qrIssuer, userName, credentials.getSecretKey());
  }
  ...
  public void saveUserCredentials(
      String userId, String secretKey, int validationCode, List<Integer> scratchCodes) {
    // no op
  }
  ...
  public void setJdbcProvisioner(
