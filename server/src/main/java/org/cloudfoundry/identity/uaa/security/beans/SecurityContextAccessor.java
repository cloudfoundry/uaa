 ...
 *
 * <p>Will be expanded as other requirements emerge.
 *
 * @author Luke Taylor
 */
public interface SecurityContextAccessor {
  ...
  /**
   * Returns true if the current invocation is being made by a client, not by or on behalf of (in
   * the oauth sense) an end user.
   */
  boolean isClient();

  /** Returns true if the current invocation is being made by a user, not by a client app. */
  boolean isUser();
  ...
  /** @return the scopes of the current principal (or empty if there is none) */
