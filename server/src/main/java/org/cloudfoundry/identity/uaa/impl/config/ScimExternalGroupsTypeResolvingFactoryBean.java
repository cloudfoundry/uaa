...
public class ScimExternalGroupsTypeResolvingFactoryBean {
  ...
  public ScimExternalGroupsTypeResolvingFactoryBean(Object o) {
    // Supported list of pipe-delimited internal to external group mappings with space-separated
    // external groups
    if (o instanceof List) {
      ...
      for (String internalToExternalGroupsMapping : ((List<String>) o)) {
        ...
        Map<String, List> existingOriginMap =
            resolvedMap.putIfAbsent(origin, externalToInternalMap);
