...
public class JdbcQueryableClientDetailsService extends AbstractQueryable<ClientDetails>
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(JdbcQueryableClientDetailsService.class);
  ...
  private static final String BASE_FIND_STATEMENT =
      "select " + CLIENT_FIELDS + " from " + CLIENT_DETAILS_TABLE;
