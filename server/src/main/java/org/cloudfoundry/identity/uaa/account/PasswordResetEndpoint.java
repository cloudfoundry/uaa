...
public class PasswordResetEndpoint {
  ...
  public ResponseEntity<PasswordResetResponse> resetPassword(
    ...
    try {
      ForgotPasswordInfo forgotPasswordInfo =
          resetPasswordService.forgotPassword(email, clientId, redirectUri);
  ...
  public ResponseEntity<LostPasswordChangeResponse> changePassword(
      @RequestBody LostPasswordChangeRequest passwordChangeRequest) {
    ...
    if (passwordChangeRequest.getChangeCode() != null) {
      try {
        ...
        ResetPasswordService.ResetPasswordResponse reset =
            resetPasswordService.resetPassword(
                expiringCode, passwordChangeRequest.getNewPassword());
  ...
  public View handleException(InvalidPasswordException t) throws ScimException {
    return new ConvertingExceptionView(
        new ResponseEntity<>(new ExceptionReport(t, false), UNPROCESSABLE_ENTITY),
        messageConverters);
  }
