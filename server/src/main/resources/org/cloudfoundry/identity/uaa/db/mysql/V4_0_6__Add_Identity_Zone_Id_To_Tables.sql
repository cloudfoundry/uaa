...
ALTER TABLE group_membership ADD COLUMN identity_zone_id VARCHAR(36) DEFAULT NULL;
...
ALTER TABLE external_group_mapping ADD COLUMN identity_zone_id VARCHAR(36) DEFAULT NULL;
...
ALTER TABLE oauth_code ADD COLUMN identity_zone_id VARCHAR(36) DEFAULT NULL;
