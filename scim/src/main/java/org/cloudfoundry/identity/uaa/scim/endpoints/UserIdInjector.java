...
/**
 * Convenience aspect for converting user ids to user names (or vice versa) and
 * injecting the result into the
...
public class UserIdInjector implements MethodInterceptor, InitializingBean {
    ...
    /**
     * @param inputIndex the index of the incoming args that may need to be
     *            converted
     */
