...
* ``curl -v "http://localhost:8080/oauth/authorize?response_type=code&client_id=app&scope=password.write&redirect_uri=http%3A%2F%2Fwww.example.com%2Fcallback" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v http://localhost:8080/login.do -H "Referer: http://login.cloudfoundry.example.com/login" -H "Accept: application/json" -H "Content-Type: application/x-www-form-urlencoded" -d "username=marissa&password=koala&X-Uaa-Csrf=abcdef" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v "http://localhost:8080/oauth/authorize?response_type=code&client_id=app&scope=password.write&redirect_uri=http%3A%2F%2Fwww.example.com%2Fcallback" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v http://localhost:8080/oauth/authorize -d "scope.0=scope.password.write&user_oauth_approval=true" --cookie cookies.txt --cookie-jar cookies.txt``
...
* ``curl -v -H "Accept:application/json" "http://localhost:8080/oauth/authorize?response_type=code&client_id=app&scope=password.write&redirect_uri=http%3A%2F%2Fwww.example.com%2Fcallback" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v -H "Accept:application/json" http://localhost:8080/login.do -H "Referer: http://login.cloudfoundry.example.com/login" -H "Accept: application/json" -H "Content-Type: application/x-www-form-urlencoded" -d "username=marissa&password=koala&X-Uaa-Csrf=abcdef" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v -H "Accept:application/json" "http://localhost:8080/oauth/authorize?response_type=code&client_id=app&scope=password.write&redirect_uri=http%3A%2F%2Fwww.example.com%2Fcallback" --cookie cookies.txt --cookie-jar cookies.txt``
* ``curl -v -H "Accept:application/json" http://localhost:8080/oauth/authorize -d "scope.0=scope.password.write&user_oauth_approval=true" --cookie cookies.txt --cookie-jar cookies.txt``
...
* curl -v -H"Authorization: Bearer $TOKEN" "http://localhost:8080/oauth/authorize?grant_type=authorization_code&client_id=identity&state=mystate&response_type=code&redirect_uri=http://localhost"
* TOKEN can be fetched by: curl -v -XPOST -H"Application/json" -u "cf:" --data "username=marissa&password=koala&client_id=cf&grant_type=password" http://localhost:8080/oauth/token
...
Curl Example      POST (Token contains ``zones.write`` scope) ::
                    ...
                    curl -v -H"Authorization: Bearer $TOKEN" \
                      ...
                      -XPOST \
                      http://localhost:8080/identity-zones
                  ...
                  PUT (Token contains ``zones.write`` scope) ::
                    ...
                    curl -v -H"Authorization: Bearer $TOKEN" \
                      ...
                      -H"Accept:application/json" \
                      -H"Content-Type:application/json" \
                      -XPUT http://localhost:8080/identity-zones/testzone1
...
Example::
    ...
    uaac target http://testzone1.localhost:8080
...
Curl Example      POST (Token contains ``zones.write`` scope) ::
                    ...
                    curl -v -H"Authorization:Bearer $TOKEN" \
                      ...
                      http://localhost:8080/identity-zones/testzone1/clients
...
Curl Example      POST (Token contains ``zones.write`` scope) :: ::
                    ...
                    curl -v -H"Authorization:Bearer $TOKEN" -XDELETE http://localhost:8080/identity-zones/testzone1/clients/limited-client
...
Curl Example      POST (Creating a SAML provider)::
                    ...
                    curl -v -H"Authorization:Bearer $TOKEN" \
                      ...
                      http://localhost:8080/identity-providers
...
Curl Example      PUT (Updating a UAA provider)::
                    ...
                    curl -v -H"Authorization:Bearer $TOKEN" \
                      ...
                      http://localhost:8080/identity-providers/[identity_provider_id]
...
Curl Example      POST (Testing an LDAP provider)::
                    ...
                    curl -v -H"Authorization:Bearer $TOKEN" \
                      ...
                      http://localhost:8080/identity-providers/test
...
Curl Example      PUT Create a user::
                    ...
                    curl -v
                      ...
                      http://localhost:8080/Users/24c1c1a9-9b30-4eaa-b8e3-d2e1aabf1dc7
