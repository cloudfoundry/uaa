...
public class LdapIdentityProviderDefinition extends ExternalIdentityProviderDefinition {
  ...
  public static final String LDAP_BASE_LOCAL_PASSWORD_COMPARE =
      LDAP_PREFIX + "base.localPasswordCompare";
  ...
  public static final String LDAP_BASE_MAIL_SUBSTITUTE_OVERRIDES_LDAP =
      LDAP_PREFIX + "base.mailSubstituteOverridesLdap";
  public static final String LDAP_BASE_PASSWORD = LDAP_PREFIX + "base.password";
  public static final String LDAP_BASE_PASSWORD_ATTRIBUTE_NAME =
      LDAP_PREFIX + "base.passwordAttributeName";
  ...
  public static final String LDAP_BASE_USER_DN_PATTERN_DELIMITER =
      LDAP_PREFIX + "base.userDnPatternDelimiter";
  public static final String LDAP_EMAIL_DOMAIN = LDAP_PREFIX + EMAIL_DOMAIN_ATTR;
  public static final String LDAP_STORE_CUSTOM_ATTRIBUTES =
      LDAP_PREFIX + STORE_CUSTOM_ATTRIBUTES_NAME;
  public static final String LDAP_EXTERNAL_GROUPS_WHITELIST =
      LDAP_PREFIX + "externalGroupsWhitelist";
  public static final String LDAP_GROUP_FILE_GROUPS_AS_SCOPES = "ldap/ldap-groups-as-scopes.xml";
  public static final String LDAP_GROUP_FILE_GROUPS_MAP_TO_SCOPES =
  ...
  public static final String LDAP_GROUPS_GROUP_ROLE_ATTRIBUTE =
      LDAP_PREFIX + "groups.groupRoleAttribute";
  public static final String LDAP_GROUPS_GROUP_SEARCH_FILTER =
      LDAP_PREFIX + "groups.groupSearchFilter";
  public static final String LDAP_GROUPS_IGNORE_PARTIAL_RESULT_EXCEPTION =
      LDAP_PREFIX + "groups.ignorePartialResultException";
  ...
  public static final String LDAP_PROFILE_FILE_SEARCH_AND_COMPARE =
  ...
  public static final List<String> LDAP_PROPERTY_NAMES =
      List.of(
  ...
  public void setPasswordEncoder(String passwordEncoder) {
    if (passwordEncoder == null
        || "org.cloudfoundry.identity.uaa.provider.ldap.DynamicPasswordComparator"
