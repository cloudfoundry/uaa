...
public class DisableFiltersInBoot implements BeanDefinitionRegistryPostProcessor {
    ...
    Logger logger = LoggerFactory.getLogger(DisableFiltersInBoot.class);
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
        ...
        for (String beanName : filterBeanNames) {
            ...
            if (beanClassName != null) {
                logger.info("Adding disabled filter registration for {}, {}", beanName, beanClassName);
                ...
                logger.info("Not adding filter registration for {}, {}", beanName, beanClassName);
            }
        }
    }
