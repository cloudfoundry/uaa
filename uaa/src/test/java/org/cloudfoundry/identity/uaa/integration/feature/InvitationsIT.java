...
public class InvitationsIT {
    ...
    public void acceptInvitation_for_samlUser() throws Exception {
        ...
        UaaBaseClientDetails appClient = IntegrationTestUtils.getClient(scimToken, baseUrl, "app");
    ...
    public void invitedOIDCUserVerified() throws Exception {
        ...
        UaaBaseClientDetails clientDetails = new UaaBaseClientDetails(clientId, null, null, "client_credentials", "scim.invite");
