...
public class OAuthErrorPage extends Page {
    ...
    /**
     * Asserts that the page does NOT display the concurrent-login-specific message.
     * Use this to verify that a stale-state replay or a forged state lands on the generic
     * error path rather than the friendly concurrent-login path.
     */
    public OAuthErrorPage assertConcurrentLoginMessageNotShown() {
        assertThatPageSource().doesNotContain("Another sign-in is already in progress");
        return this;
    }
