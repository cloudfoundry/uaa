...
public class ScimUserEndpointsMockMvcTests extends InjectedMockContextTest {
    ...
    public void setUp() throws Exception {
        ...
        clientDetails = utils().createClient(this.getMockMvc(), adminToken, clientId, clientSecret, Collections.singletonList("oauth"), Collections.singletonList("foo,bar"), Collections.singletonList("client_credentials"), authorities);
    ...
    public void verification_link_in_non_default_zone() throws Exception {
        ...
        BaseClientDetails zonedClientDetails = (BaseClientDetails)utils().createClient(this.getMockMvc(), zoneResult.getZoneAdminToken(), zonedClientId, zonedClientSecret, Collections.singletonList("oauth"), null, Arrays.asList("client_credentials"), "scim.create", null, zoneResult.getIdentityZone());
