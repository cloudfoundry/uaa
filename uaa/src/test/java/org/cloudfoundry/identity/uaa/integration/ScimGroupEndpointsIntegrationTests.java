...
public class ScimGroupEndpointsIntegrationTests {
	...
	private static final List<String> defaultGroups = Arrays.asList("openid","cloud_controller.read","cloud_controller.write","password.write","tokens.write","tokens.read","scim.userids","uaa.user","approvals.me");
