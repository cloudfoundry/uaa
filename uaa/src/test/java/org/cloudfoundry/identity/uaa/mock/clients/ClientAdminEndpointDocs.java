...
class ClientAdminEndpointDocs extends AdminClientCreator {
    ...
    private static final FieldDescriptor[] idempotentFields = new FieldDescriptor[]{
        ...
        fieldWithPath("allowpublic").optional(Collections.emptySet()).type(Arrays.asList(BOOLEAN, ARRAY)).description("If true, allow to omit client_secret for authorization_code flow in combination with PKCE"),
