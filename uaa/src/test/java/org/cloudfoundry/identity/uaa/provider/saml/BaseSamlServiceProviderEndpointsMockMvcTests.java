...
public abstract class BaseSamlServiceProviderEndpointsMockMvcTests {
    @Autowired
    ...
    public void setup() throws Exception {
        ...
        zone = zoneSwitching ? MockMvcUtils.createOtherIdentityZone(generator.generate().toLowerCase(), mockMvc, getWebApplicationContext()) : IdentityZone.getUaa();
