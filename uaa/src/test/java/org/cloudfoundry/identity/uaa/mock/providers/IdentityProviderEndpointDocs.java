...
//        LDAP_BIND_PASSWORD,
    ...
    void createOAuthIdentityProvider() throws Exception {
        ...
        FieldDescriptor[] idempotentFields = ArrayUtils.addAll(commonProviderFields, ArrayUtils.addAll(new FieldDescriptor[]{
                ...
                fieldWithPath("config.authMethod").optional("client_secret_basic").type(STRING).description("<small><mark>UAA 77.10.0</mark></small> Define explicit method to authenticate against identity provider. Supported values are client_secret_basic, client_secret_post, private_key_jwt and none. Remark: In case you switch the method from secret methods towards private_key_jwt or none, your existing relyingPartySecret is removed. If you want switch back, provide again a relyingPartySecret in configuration. Defaults to client_secret_basic."),
