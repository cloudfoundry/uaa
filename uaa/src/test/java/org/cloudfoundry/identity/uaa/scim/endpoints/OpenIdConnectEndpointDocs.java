...
class OpenIdConnectEndpointDocs extends EndpointDocs {
    ...
    void getWellKnownOpenidConf() throws Exception {
        Snippet responseFields = responseFields(
                ...
                fieldWithPath("code_challenge_methods_supported").description("<small><mark>UAA 4.31.0</mark></small>JSON array containing a list of [PKCE](https://tools.ietf.org/html/rfc7636) code challenge methods supported by this authorization endpoint."),
