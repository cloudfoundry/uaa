...
class ScimUserEndpointDocs extends EndpointDocs {
    ...
    private final String usernameDescription = "User name of the user, typically an email address. Max length: 255.";
    private final String nameObjectDescription = "A map with the user's first name and last name.";
    private final String lastnameDescription = "The user's last name. Max length: 255.";
    private final String firstnameDescription = "The user's first name. Max length: 255.";
    private final String emailListDescription = "The user's email addresses.";
    private final String emailDescription = "The email address. Max length: 255.";
    ...
    private final String userOriginDescription = "The alias of the Identity Provider that authenticated this user. The value `uaa` indicates a user from the UAA's internal user store. Max length: 36.";
    ...
    private final String aliasZidDescription = "The ID of the identity zone in which an alias of this user is maintained. Max length: 36.";
