...
public class ClientAdminEndpointsMockMvcTests {
    ...
    void testCreateClientWithInvalidRedirectUrl() throws Exception {
        UaaBaseClientDetails client = createBaseClient(new RandomValueStringGenerator().generate(), SECRET, Collections.singleton("implicit"));
    ...
    void testCreateClientWithValidLongRedirectUri() throws Exception {
        String id = new RandomValueStringGenerator().generate();
        UaaBaseClientDetails client = createBaseClient(id, SECRET, Collections.singletonList(GRANT_TYPE_JWT_BEARER), null, Collections.singletonList(id + ".read"));
    ...
    void createClient_withClientAdminToken_withAuthoritiesExcluded(
        ...
        try {
            ...
            UaaBaseClientDetails clientDetails = JsonUtils.readValue(createResult.andReturn().getResponse().getContentAsString(), UaaBaseClientDetails.class);
    ...
    void testCreateClient_With_Long_Secret() throws Exception {
        UaaBaseClientDetails client = createBaseClient(new RandomValueStringGenerator().generate(), SECRET_TOO_LONG, Collections.singleton("client_credentials"));
        MockHttpServletRequestBuilder createClientPost = post("/oauth/clients")
                .header("Authorization", "Bearer " + adminToken)
                .accept(APPLICATION_JSON)
                .contentType(APPLICATION_JSON)
    ...
    void testClientCRUDAsAdminUser() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(getClient)
                ...
                .andReturn();
        UaaBaseClientDetails clientDetails = JsonUtils.readValue(mvcResult.getResponse().getContentAsString(), UaaBaseClientDetails.class);
        ...
        UaaBaseClientDetails updatedClientDetails = JsonUtils.readValue(result.getResponse().getContentAsString(), UaaBaseClientDetails.class);
        ...
        UaaBaseClientDetails deletedClientDetails = JsonUtils.readValue(deleteResult.getResponse().getContentAsString(), UaaBaseClientDetails.class);
    ...
    void create_client_and_check_created_by() throws Exception {
        ...
        UaaBaseClientDetails clientDetails = createClient(Arrays.asList("password.write", "scim.write", "scim.read", "clients.write"));
    ...
    void testCreate_RestrictedClient_Fails() throws Exception {
        ...
        UaaBaseClientDetails clientWithAuthorities = createBaseClient(id, SECRET, grantTypes, new UaaScopes().getUaaScopes(), null);
        UaaBaseClientDetails clientWithScopes = createBaseClient(id, SECRET, grantTypes, null, new UaaScopes().getUaaScopes());
    ...
    void testCreate_RestrictedClient_Succeeds() throws Exception {
        ...
        UaaBaseClientDetails client = createBaseClient(id, SECRET, Arrays.asList("client_credentials", "password"), scopes, scopes);
    ...
    void testCreateClientsTxFailure_Secret_Too_Long() throws Exception {
        int count = 5;
        UaaBaseClientDetails[] details = createBaseClients(count, SECRET_TOO_LONG, null);
    ...
    void testCreateClientsTxSuccess() throws Exception {
        int count = 5;
        UaaBaseClientDetails[] details = createBaseClients(count, SECRET, null);
        MockHttpServletRequestBuilder createClientPost = post("/oauth/clients/tx")
                .header("Authorization", "Bearer " + adminToken)
                .accept(APPLICATION_JSON)
                .contentType(APPLICATION_JSON)
    ...
    void testCreateClientsTxDuplicateId() throws Exception {
        UaaBaseClientDetails[] details = createBaseClients(5, SECRET, null);
    ...
    void test_InZone_ClientWrite_Failure_with_Min_Length_Secret() throws Exception {
        ...
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, "", "openid", GRANT_TYPE_AUTHORIZATION_CODE, "", "http://sample.redirect");
    ...
    void test_InZone_ClientWrite_Using_ZonesDotAdmin() throws Exception {
        ...
        MockMvcUtils.IdentityZoneCreationResult result = MockMvcUtils.createOtherIdentityZoneAndReturnResult(subdomain, mockMvc, webApplicationContext, null, IdentityZoneHolder.getCurrentZoneId());
        String clientId = generator.generate();
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, "", "openid", GRANT_TYPE_AUTHORIZATION_CODE, "", "http://some.redirect.url.com");
        client.setClientSecret("secret");
        MockMvcUtils.createClient(mockMvc, result.getZoneAdminToken(), client, result.getIdentityZone(),
                status().isCreated());
    }
    ...
    void test_InZone_ClientWrite_Using_ZonesDotClientsDotAdmin() throws Exception {
        ...
        String clientId = generator.generate();
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, "", "", "client_credentials", "zones." + id + ".clients.admin", "http://some.redirect.url.com");
        client.setClientSecret("secret");
        ...
        UaaBaseClientDetails newclient = new UaaBaseClientDetails(clientId, "", "openid", GRANT_TYPE_AUTHORIZATION_CODE, "", "http://some.redirect.url.com");
    ...
    void manageClientInOtherZone_Using_AdminUserTokenFromDefaultZone() throws Exception {
        ...
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, "", "openid", GRANT_TYPE_AUTHORIZATION_CODE, "", "http://some.redirect.url.com");
        client.setClientSecret("secret");
        UaaBaseClientDetails createdClient = MockMvcUtils.createClient(mockMvc, adminUserToken, client,
                result.getIdentityZone(), status().isCreated());
        ...
        UaaBaseClientDetails updatedClientDetails = JsonUtils.readValue(mvcResult.getResponse().getContentAsString(), UaaBaseClientDetails.class);
        assertEquals(client.getClientId(), updatedClientDetails.getClientId());
        assertThat(updatedClientDetails.getAuthorizedGrantTypes(), PredicateMatcher.has(m -> m.equals(GRANT_TYPE_AUTHORIZATION_CODE)));
    ...
    void test_InZone_ClientRead_Using_ZonesDotClientsDotRead() throws Exception {
        ...
        String id = result.getIdentityZone().getId();
        String clientId = generator.generate();
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, "", "", "client_credentials", "zones." + id + ".clients.read", "http://some.redirect.url.com");
        client.setClientSecret("secret");
        client = MockMvcUtils.createClient(mockMvc, adminToken, client);
        client.setClientSecret("secret");
    ...
    void testCreateClientsTxClientCredentialsWithoutSecret() throws Exception {
        UaaBaseClientDetails[] details = createBaseClients(5, null, null);
    ...
    void testUpdateClientsTxSuccess() throws Exception {
        int count = 5;
        UaaBaseClientDetails[] details = new UaaBaseClientDetails[count];
        for (int i = 0; i < details.length; i++) {
            details[i] = (UaaBaseClientDetails) createClient(adminToken, null, SECRET, null);
    ...
    void testUnsuccessfulSecretChangeEvent() throws Exception {
        ...
        UaaBaseClientDetails client = createBaseClient(null, SECRET, Arrays.asList("password", "client_credentials"), scopes, scopes);
        MockHttpServletRequestBuilder createClientPost = post("/oauth/clients")
                .header("Authorization", "Bearer " + adminToken)
                .accept(APPLICATION_JSON)
                .contentType(APPLICATION_JSON)
    ...
    void testGetClientDetailsSortedByLastModified() throws Exception {
        ...
        Collection<UaaBaseClientDetails> clientDetails = JsonUtils.readValue(body, new TypeReference<SearchResults<UaaBaseClientDetails>>() {
        }).getResources();
    ...
    void testGetClientsLargerThanMax_whenCountParamIsProvided() throws Exception {
        ...
        SearchResults<UaaBaseClientDetails> clientDetailsSearchResults = JsonUtils.readValue(body, new TypeReference<SearchResults<UaaBaseClientDetails>>() {
        });
    ...
    void testPutClientModifyAuthorities() throws Exception {
        ...
        UaaBaseClientDetails modified = new UaaBaseClientDetails(client);
    ...
    void testPutClientModifyName() throws Exception {
        ...
        Map<String, Object> requestBody = JsonUtils.readValue(JsonUtils.writeValueAsString(new UaaBaseClientDetails(client)), new TypeReference<Map<String, Object>>() {
        });
    ...
    private UaaBaseClientDetails createClient(List<String> authorities) throws Exception {
        String clientId = generator.generate().toLowerCase();
        List<String> scopes = Arrays.asList("foo", "bar", "oauth.approvals");
        ClientDetailsModification client = createBaseClient(clientId, SECRET, Collections.singleton("client_credentials"), authorities, scopes);
        MockHttpServletRequestBuilder createClientPost = post("/oauth/clients")
                ...
                .content(JsonUtils.writeValueAsString(client));
        ResultActions createResult = mockMvc.perform(createClientPost).andExpect(status().isCreated());
        return JsonUtils.readValue(createResult.andReturn().getResponse().getContentAsString(), UaaBaseClientDetails.class);
    }
    ...
    protected ClientDetails createClient(String token, String id, String clientSecret, Collection<String> grantTypes) throws Exception {
        UaaBaseClientDetails client = createBaseClient(id, clientSecret, grantTypes);
        MockHttpServletRequestBuilder createClientPost = post("/oauth/clients")
                .header("Authorization", "Bearer " + token)
                .accept(APPLICATION_JSON)
                .contentType(APPLICATION_JSON)
