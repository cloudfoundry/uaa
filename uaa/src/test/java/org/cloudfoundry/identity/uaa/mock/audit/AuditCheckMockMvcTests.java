...
class AuditCheckMockMvcTests {
    ...
    void client_modification_logs_authorities_and_scopes() throws Exception {
        ...
        UaaBaseClientDetails client = new UaaBaseClientDetails(clientId, resource, scopes, grantTypes, authorities);
    ...
    void testUserApprovalAdded() throws Exception {
        clientRegistrationService.updateClientDetails(new UaaBaseClientDetails("login", "oauth", "oauth.approvals", "password", "oauth.login"));
    ...
    void generateUserCreatedEvent_DuringLoginServerAuthorize() throws Exception {
        clientRegistrationService.updateClientDetails(new UaaBaseClientDetails("login", "oauth", "oauth.approvals", "authorization_code,password,client_credentials", "oauth.login", "http://localhost:8080/uaa"));
